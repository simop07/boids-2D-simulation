...
// predator. It evolves a single boid according to the 3 rules, then it
// reduces/increases its velocity keeping it lower/higher than a fixed max/min
// velocity, applies the separation rule for the predator and the function
// pacman taking care of the borders
